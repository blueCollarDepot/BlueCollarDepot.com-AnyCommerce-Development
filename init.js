...
app.rq.push(['templateFunction','productTemplate','onCompletes',function(P) {
	...
	if(safePID === "OVERALLSTEST1"){
		...
		$("<div class='customizerMenu'>"
			...
			+ "					<div class='leftPocketEmbroidCont logoEmbroidMenu'><p>Please select a value/enter your text for all boxes below if you want embroidery for this section to avoid any delays in processing time. Please adhere to the character max as going over the character limit will also cause delays in processing time.</p></div>"
			...
			+ "					<div class='rightPocketEmbroidCont logoEmbroidMenu'><p>Please select a value/enter your text for all boxes below if you want embroidery for this section to avoid any delays in processing time. Please adhere to the character max as going over the character limit will also cause delays in processing time.</p></div>"
			...
			+ "					<div class='leftShoulderEmbroidCont logoEmbroidMenu'><p>Please select a value/enter your text for all boxes below if you want embroidery for this section to avoid any delays in processing time. Please adhere to the character max as going over the character limit will also cause delays in processing time.</p></div>"
			...
			+ "					<div class='rightShoulderEmbroidCont logoEmbroidMenu'><p>Please select a value/enter your text for all boxes below if you want embroidery for this section to avoid any delays in processing time. Please adhere to the character max as going over the character limit will also cause delays in processing time.</p></div>"
